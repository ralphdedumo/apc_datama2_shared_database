  ...
  CREATE TABLE "MI181_RADEDUMO"."BILL" 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "MI181_RADEDUMO"."CUSTOMER1" 
   (	"ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"CHECK_IN_SLIP_ID" NUMBER(*,0) NOT NULL ENABLE, 
	 CONSTRAINT "CADSFASDF_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "MI181_RADEDUMO"."EMPLOYEE" 
   (	"ID" NUMBER(*,0) NOT NULL ENABLE, 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "MI181_RADEDUMO"."HOTEL" 
   (	"ID" NUMBER(*,0) NOT NULL ENABLE, 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "MI181_RADEDUMO"."KEY_HOLDER" 
   (	"ID" NUMBER(*,0) NOT NULL ENABLE, 
	"KEY_HOLDER" VARCHAR2(45) NOT NULL ENABLE, 
	 CONSTRAINT "KEY_HOLDER_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "MI181_RADEDUMO"."ROOM" 
   (	"ID" NUMBER(*,0) NOT NULL ENABLE, 
